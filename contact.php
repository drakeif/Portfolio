...
$header .= "From: Новая заявка <v.ohlopkov100@gmail.com>\n\n";	
$mail = mail("v.ohlopkov100@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
